...
| `CLAUDE_CHAT_MODEL` / `CLAUDE_ANALYSIS_MODEL` | *(Optional)* Claude models for conversations and analysis (defaults `claude-sonnet-5` for conversations, `claude-opus-5-5` for analysis) |
